// ============================================================================
//  BLACK BRIDGE — a body-level black curtain for the mobile orb→The Road hand-off.
// ============================================================================
//  After the phone morph (BakedOrb) ends on the globe, fade this layer IN over the
//  home, swap routes underneath, then fade it OUT once The Road signals ready —
//  so the user sees:  morph → home fades to black → (load) → fade in The Road.
...
//  frame), so the globe persists across the route swap until The Road's own globe
...
function fadeIn(ms = 450, { image } = {}) {
  ...
  // the home fades to black (and persists across the swap until The Road is ready).
